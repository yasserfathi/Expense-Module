    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="expenses">
                    <a href="#expenses">Expenses</a>
                                ...
                                <a href="#expenses-GETapi-expenses--id-">Get a single expense</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="expenses-PUTapi-expenses--id-">
                                <a href="#expenses-PUTapi-expenses--id-">Update an expense</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="expenses-DELETEapi-expenses--expense-">
                                <a href="#expenses-DELETEapi-expenses--expense-">Delete an expense</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>API for managing expenses Modulle</p>
<aside>
...
<div class="bash-example">
    ...
    --get "http://localhost/api/expenses?category=office" \
...
<code class="language-json" style="max-height: 300px;">App\Modules\Expenses\Http\Resources\ExpenseCollection</code>
 </pre>
    </span>
...
<i>optional</i> &nbsp;
    ...
    <br>
<p>Filter by category Example: <code>office</code></p>
            </div>
                </form>
...
<span id="example-responses-POSTapi-expenses">
            <blockquote>
            <p>Example response (201, Expense created):</p>
        </blockquote>
                <pre>

<code class="language-json" style="max-height: 300px;">App\Modules\Expenses\Http\Resources\ExpenseResource</code>
 </pre>
    </span>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must not be one of <code>untitled</code> or <code>undefined</code> Must not be greater than 255 characters. Example: <code>b</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
Must be one of:
<ul style="list-style-type: square;"><li><code>cat1</code></li> <li><code>cat2</code></li> <li><code>cat3</code></li> <li><code>other</code></li></ul>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be a valid date. Must be a date before or equal to <code>today</code>. Example: <code>2021-07-13</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<p>Must not be greater than 1000 characters. Example: <code>n</code></p>
                    ...
                    <h2 id="expenses-GETapi-expenses--id-">Get a single expense</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/expenses/architecto" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/expenses/architecto"
);
...
<code class="language-json" style="max-height: 300px;">App\Modules\Expenses\Http\Resources\ExpenseResource</code>
            ...
            <blockquote>
            <p>Example response (404, Expense not found):</p>
        </blockquote>
                <pre>
...
<p>The ID of the expense. Example: <code>architecto</code></p>
                    ...
                    <h2 id="expenses-PUTapi-expenses--id-">Update an expense</h2>
...
<span id="example-responses-PUTapi-expenses--id-">
            <blockquote>
            <p>Example response (200, Expense updated):</p>
        </blockquote>
                <pre>
...
<p>Must not be greater than 1000 characters. Example: <code>n</code></p>
                    ...
                    <h2 id="expenses-DELETEapi-expenses--expense-">Delete an expense</h2>
...
<span id="example-requests-DELETEapi-expenses--expense-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-DELETEapi-expenses--expense-">
            <blockquote>
            <p>Example response (204, Expense deleted):</p>
        </blockquote>
                <pre>
<code>Empty response</code>
 </pre>
    </span>
<span id="execution-results-DELETEapi-expenses--expense-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-DELETEapi-expenses--expense-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-DELETEapi-expenses--expense-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-DELETEapi-expenses--expense-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-DELETEapi-expenses--expense-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-DELETEapi-expenses--expense-" data-method="DELETE"
      data-path="api/expenses/{expense}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('DELETEapi-expenses--expense-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-DELETEapi-expenses--expense-"
                    onclick="tryItOut('DELETEapi-expenses--expense-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-expenses--expense-"
                    onclick="cancelTryOut('DELETEapi-expenses--expense-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-DELETEapi-expenses--expense-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <b><code>api/expenses/{expense}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="DELETEapi-expenses--expense-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="DELETEapi-expenses--expense-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="expense"                data-endpoint="DELETEapi-expenses--expense-"
               value="architecto"
               data-component="url">
    <br>
<p>The expense. Example: <code>architecto</code></p>
            </div>
                    </form>
